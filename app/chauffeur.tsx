...
import MapView, { Marker, Polygon, Polyline, Region, Camera } from 'react-native-maps';
...
const imageMap: Record<string, any> = {
  ...
  taxi : require('../assets/icons/moto.png'),
};
...
export default function MapeCovoiturage () {
  ...
  useEffect(() => {    
    ...
    const camera: Camera = {
      center: {
        latitude: 48.8588443, // Exemple : Tour Eiffel
        longitude: 2.2943506,
      },
      pitch: 60, // Inclinaison pour voir les bâtiments en 3D
      heading: 0, // Orientation
      altitude: 500, // Plus bas pour être plus proche
      zoom: 18,
    }
  ...
  return(
      ...
      <View style={styles.searchContainer}>
        ...
        /> */}
        <Button title="Activer GPS" onPress={handleSearch} />
      </View>
        <MapView
          ref={mapRef} 
          style={{ flex: 1 }}
